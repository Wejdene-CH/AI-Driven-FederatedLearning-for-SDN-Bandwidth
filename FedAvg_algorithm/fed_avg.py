...
class CSVDataset(Dataset):
    """Custom Dataset to load data from a CSV file."""
...
class FedAvg:
    ...
    def __init__(self, args: Dict[str, Any]):
        ...
        if self.args.model_name == "cnn":
            self.root_model = CNN(n_channels=1, n_classes=5).to(self.device)
    ...
    def _get_data(
        ...
        train_set = CSVDataset(csv_file=f"./Network_Intrusion_Detection_example/Train_data.csv")
        test_set = CSVDataset(csv_file=f"./Network_Intrusion_Detection_example/Test_data.csv")
